...
import com.wycliffe.producer.service.HousingService;
...
public class HousingController {
    @Autowired private HousingService housingService;
    ...
    public ResponseEntity <HashMap<String,Object>> fetchAccount(){
        ...
        try{
            List <Apartments> listAccount = new ArrayList<>();
            listAccount = housingService.getAccounts();
